...
export interface Booking {
  ...
  qc5_date: string | null;                   // QC5 ตรวจสอบคุณภาพงานก่อสร้าง
...
export const bookings: Booking[] = computeFlags([
...

  {
    ...
    inspect1_ready: '02/01/2026',
    inspect1_appt: '12/01/2026',
    inspect1_date: '12/01/2026',
    inspect1_result: 'ไม่ผ่าน',
    inspect2_schedule: '17/01/2026',
    inspect2_ready: '16/01/2026',
...
function generateBulkBookings(): any[] {
  ...
  while (currentTotal < targetBacklog) {
    ...
    const booking = {
      ...
      inspect2_ready: hasInspect2 ? '16/02/2026' : null,
      ...
      inspect3_schedule: hasInspect3 ? '02/03/2026' : null,

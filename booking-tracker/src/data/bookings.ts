...
export interface Booking {
  ...
  // ─────────────────────────────────────────────
  livnex_able_status: string | null;           // ใช้ JD_FINAL_RESULTS master
...
export const bookings: Booking[] = [
  {
    ...
    banks_submitted: [
      ...
      { bank: 'Proptiane', submit_date: null, preapprove_date: null, preapprove_result: null, result: null, result_date: null, approved_amount: null, remark: 'โอนสด - ไม่ต้องยื่น JD' }
    ],
    selected_bank: 'CASH',
  ...
  while (currentTotal < targetBacklog) {
    ...
    const banksSubmitted = isCash
      ? [
          ...
          { bank: 'Proptiane' as BankCode, submit_date: null, preapprove_date: null, preapprove_result: null, result: null, result_date: null, approved_amount: null, remark: 'โอนสด - ไม่ต้องยื่น JD' }
        ]
